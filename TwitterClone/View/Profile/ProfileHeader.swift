...
class ProfileHeader: UICollectionReusableView {
    ...
    private let bioLabel: UILabel = {
        ...
        label.text = "This is a user bio that will span more than one line for tet purposes"
        return label
    }()
    ...
    override init(frame: CGRect) {
        ...
        editProfileFollowButton.anchor(top: containerView.bottomAnchor, right: rightAnchor, paddingTop: 12, paddingRight: 16)
...
extension ProfileHeader: ProfileFilterViewDelegate{
    func filterView(_ view: ProfileFilterView, didSelect index: Int) {
        ...
        print("DEBUG: DELEGATE ACTION FROM HEADER TO CONTROLLER WITH FILTER \(filter)")
